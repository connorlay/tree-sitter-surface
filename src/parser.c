...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 186:
      ...
      if (!aux_sym_attribute_value_token1_character_set_1(lookahead)) ADVANCE(186);
      END_STATE();
    case 187:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_fragment] = STATE(137),
    [sym__node] = STATE(16),
    [sym_tag] = STATE(16),
    [sym_component] = STATE(16),
    [sym_block] = STATE(16),
    [sym_start_markdown] = STATE(130),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(152)] = 2309,
  [SMALL_STATE(153)] = 2313,
  [SMALL_STATE(154)] = 2317,
  [SMALL_STATE(155)] = 2321,
  [SMALL_STATE(156)] = 2325,
  [SMALL_STATE(157)] = 2329,
  [SMALL_STATE(158)] = 2333,
  [SMALL_STATE(159)] = 2337,
  [SMALL_STATE(160)] = 2341,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(109),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(59),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(105),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(104),
  ...
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(114),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(60),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(106),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(107),
  [87] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(92),
  ...
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 1),
  ...
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_value, 1),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_value, 3),
  ...
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_value, 2),
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block_name, 1),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_name, 1),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subblock_name, 1),
  [310] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subblock_name, 1),
  ...
  [328] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__public_comment_repeat1, 2), SHIFT_REPEAT(121),
  [331] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__public_comment_repeat1, 2),
  [333] = {.entry = {.count = 1, .reusable = false}}, SHIFT(23),
  [335] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__public_comment_repeat1, 2), SHIFT_REPEAT(116),
